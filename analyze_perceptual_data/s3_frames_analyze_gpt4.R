# Compare the social perceptual evaluations between GPT4 and humans in the frame data
...
load("/path/data_megaperception_frames/processed_data_5batches.RData")
...
pdf("/path/results_megaperception_frames/correlation_raw_improvement.pdf",height = 5,width = 5)
...
write.csv(iccs,"/path/results_megaperception_frames/iccs_between_gpt_rounds.csv")
...
for(ki in k){
  ...
  avg_data <- read.csv(paste("/path/results_megaperception_frames/avgcorr_table_",ki,".csv",sep=""))
  ...
  pdf(paste("/path/results_megaperception_frames/scatterplot_avgcorr_",ki,".pdf",sep=""),width = 20,height = 10)
  print(p)
  dev.off()
...
# Load frame order (data are saved in spreadsheet order and from the PicDips1 to PicDisp6)
clips_human <- read.csv('/path/data_megaperception_clips/megaperception_clip_order.csv',sep = ";")
...
# Plot the matrices
pdf("/path/results_megaperception_frames/gpt_cormat_ordered_by_human_clustering.pdf",width = 20,height = 20)
...
dev.off()
pdf("/path/results_megaperception_frames/human_cormat_ordered_by_human_clustering.pdf",width = 20,height = 20)
...
pdf("/path/results_megaperception_frames/PCoA_comparison_gpt_mean.pdf",width = 8,height = 8)
