# GPT social perception: Preprocess the GPT data for megaperception clip experiment
...
for(batch in seq(from=1,to=5)){
  ...
  # Load GPT data
  data_gpt <- read.csv(paste("/path/data_megaperception_clips/batch",batch,"/batch",batch,"_data.csv",sep = ""),sep = ",")
  clips_gpt <- read.csv(paste("/path/data_megaperception_clips/batch",batch,"/batch",batch,"_clip_order.csv",sep = ""),header = FALSE)
  clip_codes <-  read.csv(paste("/path/data_megaperception_clips/batch",batch,"/batch",batch,"_matchtable.csv",sep = ""))
...
save(data,file = "/path/data_megaperception_clips/processed_data_5batches.RData")
