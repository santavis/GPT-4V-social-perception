# GPT social perception: Preprocess the GPT4 data for frame experiment
...
for(batch in seq(from=1,to=5)){
  ...
  # Load GPT data
  data_gpt <- read.csv(paste("/path/data_megaperception_frames/batch",batch,"/batch",batch,"_data.csv",sep = ""),sep = ",")
  frames_gpt <- read.csv(paste("/path/data_megaperception_frames/batch",batch,"/batch",batch,"_frame_order.csv",sep = ""),header = FALSE)
  frame_codes <-  read.csv(paste("/path/data_megaperception_frames/batch",batch,"/batch",batch,"_matchtable.csv",sep = ""))
...
save(data,file = "/path/data_megaperception_frames/processed_data_5batches.RData")
