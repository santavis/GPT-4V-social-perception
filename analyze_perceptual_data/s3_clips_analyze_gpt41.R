# Compare the social perceptual evaluations between GPT4.1 Vision and humans in the video data
...
videos_human <- read.csv('/path/data_megaperception_clips_gpt41/megaperception_clip_order.csv',sep = ";")
...
load("/path/data_megaperception_clips_gpt41/processed_data_5batches.RData")
...
pdf("/path/results_megaperception_clips_gpt41/correlation_raw_improvement.pdf",height = 5,width = 5)
...
write.csv(iccs,"/path/results_megaperception_clips_gpt41/iccs_between_gpt_rounds.csv")
...
pdf("/path/results_megaperception_clips_gpt41/scatterplot_socialfeatures.pdf",width = 8, height = 8)
...
for(ki in k){
  ...
  avg_data <- read.csv(paste("/path/results_megaperception_clips_gpt41/avgcorr_table_",ki,".csv",sep=""))
  ...
  pdf(paste("/path/results_megaperception_clips_gpt41/scatterplot_avgcorr_",ki,".pdf",sep=""),width = 20,height = 10)
  print(p)
  dev.off()
...
# Plot the matrices
pdf("/path/results_megaperception_clips_gpt41/gpt_cormat_ordered_by_human_clustering.pdf",width = 20,height = 20)
...
dev.off()
pdf("/path/results_megaperception_clips_gpt41/human_cormat_ordered_by_human_clustering.pdf",width = 20,height = 20)
...
pdf("/path/results_megaperception_clips_gpt41/PCoA_comparison_gpt_mean.pdf",width = 8,height = 8)
...
write.csv(data_gpt,"/path/data_megaperception_clips_gpt41/data_gpt_5batches_28052025.csv",row.names = T)
write.csv(data_nonzero_human,"/path/data_megaperception_clips_gpt41/data_human_28052025.csv",row.names = T)
