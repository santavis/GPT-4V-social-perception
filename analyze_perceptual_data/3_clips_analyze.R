# Compare the social perceptual evaluations between GPT4 Vision and humans in the clip data
...
# For how many features the GPT exceeds individual human ratings?
...
write.csv(data_gpt,"path/data_gpt_5batches_15052024.csv",row.names = T)
write.csv(data_nonzero_human,"path/data_human_15052024.csv",row.names = T)
