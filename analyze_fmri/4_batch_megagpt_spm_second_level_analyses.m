%% Second level analyses of fMRI data with GPT derived regressors
...
base_indir = 'path/first_level_gpt/'; % First level directory
base_output = 'path/second_level_gpt/'; % Output dir
