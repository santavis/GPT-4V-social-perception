%% First level analyses of fMRI data with human derived regressors
...
regressor_dir = 'path/regressors/human/'; % Path to regressor directory
first_level_dir = 'path/first_level_human/'; % Output directory
...
for j = 1:length(filteredFirstColumn)
    ...
    feature_folder = sprintf('path/first_level_human/features/%s', feature);
