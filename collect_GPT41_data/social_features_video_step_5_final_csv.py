"""
This is the fifth step in collecting video data.
...
# This will create as many combined files as you have extra rounds (e.g. combined_output_1_0.csv, combined_output_1-1.csv).
