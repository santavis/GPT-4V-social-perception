"""
This is the fourth and last step in collecting image data.
...
input_dir = 'path/ratings/data/gpt_4-1_data/average/input' #CHANGE
output_dir = 'path/ratings/data/gpt_4-1_data/average/all_averages' #CHANGE
