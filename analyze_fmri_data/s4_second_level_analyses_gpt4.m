%% Second level analyses of fMRI data with GPT4 derived regressors
% Batch the second level analysis over social features
%
% Severi Santavirta & Yuhang Wu 9.6.2025

% Define the directories
base_indir = '/path/first_level_gpt'; % First-level input directory
base_output = '/path/second_level_gpt'; % Second-level output directory
