%% Second level analyses of fMRI data with human derived regressors (Matching with the GPT4 data)
% Batch the second level analysis over social features
%
% Severi Santavirta & Yuhang Wu 9.6.2025

% Define the directories
base_indir = '/path/first_level_human'; % First-level input directory
base_output = '/path/second_level_human'; % Second-level output directory
