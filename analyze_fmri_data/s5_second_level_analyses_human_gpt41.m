%% Second level analyses of fMRI data with human derived regressors (Matching with the GPT4.1 data)
% Batch the second level analysis over social features
%
% Severi Santavirta & Yuhang Wu 9.6.2025

% Define the directories
base_indir = '/pathfirst_level_human_gpt41'; % First-level input directory
base_output = '/path/second_level_human_gpt41';  % Second-level output directory
mask = '/path/megafmri_localizer_gm_mask_3mm.nii'; % Brainmask
...
parfor j = 1:length(created_folders)
...
% Analyze main effects without covariates
