%% Second level analyses of fMRI data with GPT4.1 derived regressors
% Batch the second level analysis over social features
%
% Severi Santavirta & Yuhang Wu 9.6.2025

% Define the directories
base_indir = '/path/first_level_gpt41'; % First-level input directory
base_output = '/path/second_level_gpt41'; % Second-level output directory
