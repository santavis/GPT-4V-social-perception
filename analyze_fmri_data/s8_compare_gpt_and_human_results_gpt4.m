%% Compare the feature specific fMRI results for social perception between GPT-4 and humans
...
% Define directories
gpt_dir = '/path/second_level_gpt/'; % Input GPT results
human_dir = '/path/second_level_human/'; % Input human results
...
writetable(results_table, '/path/cor_and_threshold_results_gpt4.csv');
