%% Build GPT4 and human regressors for all 136 social features
...
datapath_gpt = '/path/data_gpt_5batches_15052024.csv'; % GPT rating data
datapath_human = '/path/data_human_15052024.csv'; % Human rating data
datapath_log = '/pathpresentation_log_files'; % fMRI presentation log files
...
% GPT is missing two scenes (these are not in the fmri dataset though), delete these rows from both datasets
