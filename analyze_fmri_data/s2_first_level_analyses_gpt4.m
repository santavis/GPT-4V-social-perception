%% First level analyses of fMRI data with GPT4 derived regressors
...
regressor_dir = '/path/regressors/gpt'; % Regressors
first_level_dir = '/path/first_level_gpt'; % Output folder
...
load('/path/gpt/localizer_sub-001_gpt_regressors.mat');
