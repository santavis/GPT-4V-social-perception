%% First level analyses of fMRI data with GPT4.1 derived regressors
...
regressor_dir = '/path/regressors/gpt41'; % Regressors
first_level_dir = '/path/first_level_gpt41'; % Output folder
...
load('/path/gpt41/localizer_sub-001_gpt_regressors.mat');
