%% First level analyses of fMRI data with human derived regressors (Matching with the GPT4 data)
...
regressor_dir = '/path/regressors/human'; % Regressors
first_level_dir = '/path/first_level_human'; % Output folder
...
load('/path/regressors/human/localizer_sub-001_human_regressors.mat');
